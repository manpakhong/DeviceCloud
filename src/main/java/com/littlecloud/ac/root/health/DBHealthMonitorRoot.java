package com.littlecloud.ac.root.health;
...
import com.littlecloud.ac.health.HealthMonitor;
...
public class DBHealthMonitorRoot extends DBHealthMonitor {

	private static final Logger log = Logger.getLogger(DBHealthMonitorRoot.class);

	private static final PropertyService<DBHealthMonitorRoot> ps = new PropertyService<DBHealthMonitorRoot>(DBHealthMonitorRoot.class);
	...
	private static final Integer health_db_info_max_connection = DBHealthMonitorRoot.getMaxDBConnection();
	...
	public static Integer getMaxDBConnection()
	{
		...
		File f = new File(System.getProperty("db.root.properties"));
		if( f.exists() )
		{
			try
			{
	...
	public static void main(String args[])
	{
		...
		DBHealthMonitorRoot dbmon = new DBHealthMonitorRoot();
		dbmon.collectInfo();
