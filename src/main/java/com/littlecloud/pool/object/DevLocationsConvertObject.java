...
public class DevLocationsConvertObject extends PoolObject implements PoolObjectIf, Serializable{
	...
	private ArrayList<LocationList> location_list; // realtime location data
	private ArrayList<DeviceGpsRecordsPoints> point_list; // realtime location data
	private LocationList last_report_location; 
	private LocationList last_query_location;
	
	private ArrayList<LocationList> location_list_to_db; //not using, refer to DevLocationReportObject
	...
	public ArrayList<DeviceGpsRecordsPoints> getPoint_list() {
		return point_list;
	}

	public void setPoint_list(ArrayList<DeviceGpsRecordsPoints> point_list) {
	...
	public String toString() {
		...
		builder.append("DevLocationsConvertObject [sn=");
		builder.append(sn);
