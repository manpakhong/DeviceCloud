...
@Entity
@Table(name = "device_daily_dpi_usages")
public class DeviceDailyDpiUsages extends DBObject implements java.io.Serializable
{
	private Integer id;
	...
	public String toString() {
		...
		builder.append("DeviceDailyDpiUsages [id=");
		builder.append(id);
