...
@Embeddable
public class DeviceGpsRecordsId implements java.io.Serializable {

	private int networkId;
	private int deviceId;
	private int unixtime;

	public DeviceGpsRecordsId() {
	}

	public DeviceGpsRecordsId(int networkId, int deviceId, int unixtime) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeviceGpsRecordsId))
			return false;
		DeviceGpsRecordsId castOther = (DeviceGpsRecordsId) other;
	...
	public String toString() {
		...
		builder.append("DeviceGpsRecordsId [networkId=");
