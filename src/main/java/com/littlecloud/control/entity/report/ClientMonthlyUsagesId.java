...
@Embeddable
public class ClientMonthlyUsagesId implements java.io.Serializable {
	private static final int UUID_LENGTH = 45; // UUID field length
	private String Id;
	private Integer unixtime;

	public ClientMonthlyUsagesId() {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClientMonthlyUsagesId))
			return false;
		ClientMonthlyUsagesId castOther = (ClientMonthlyUsagesId) other;
	...
	public String toString() {
		...
		builder.append("ClientMonthlyUsagesId [Id=");
		builder.append(Id);
