...
@Embeddable
public class DeviceMonthlyUsagesId implements java.io.Serializable {
	private static final int UUID_LENGTH = 45; // UUID field length
	private String Id;
	private Integer unixtime;

	public DeviceMonthlyUsagesId() {
		Id = TableMappingUtil.getInstance().genUUID(UUID_LENGTH);
	}

	public DeviceMonthlyUsagesId(String Id, Integer unixtime) {
		this.Id = Id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeviceMonthlyUsagesId))
			return false;
		DeviceMonthlyUsagesId castOther = (DeviceMonthlyUsagesId) other;
	...
	public String toString() {
		...
		builder.append("DeviceMonthlyUsagesId [Id=");
		builder.append(Id);
