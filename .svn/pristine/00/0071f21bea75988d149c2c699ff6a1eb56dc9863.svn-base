...
public class StopRequeryCpSessionInfoObject extends PoolObject implements PoolObjectIf, Serializable{
	...
	public StopRequeryCpSessionInfoObject(Integer ianaId, String clientMac, String ssid, String organizationId, Integer networkId){
